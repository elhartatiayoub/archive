...
public class Comment implements Serializable {
	...
	@ManyToOne(targetEntity=com.archive.spring.model.Image.class, fetch=FetchType.LAZY)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})	
	@JoinColumns({ @JoinColumn(name="ImageID", referencedColumnName="ID", nullable=false) })	
	private com.archive.spring.model.Image image;
	
	@ManyToOne(targetEntity=com.archive.spring.model.User.class, fetch=FetchType.LAZY)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})	
	@JoinColumns({ @JoinColumn(name="UserEmail", referencedColumnName="Email", nullable=false) })	
	...
	public void setUser(com.archive.spring.model.User value) {
		this.user = value;
	}
	
	public com.archive.spring.model.User getUser() {
		return user;
	}
	
	public void setImage(com.archive.spring.model.Image value) {
		this.image = value;
	}
	
	public com.archive.spring.model.Image getImage() {
		return image;
	}
