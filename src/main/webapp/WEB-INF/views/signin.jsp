<%-- 
    ...
    Author     : Sara
--%>
<%@page import="com.archive.spring.form.UserSignForm"%>
...
<html>
    ...
    <body>
	  ...
	  <div class="form-content clearfix">
		...
		<form:form action="/SpringMVCHibernate/connect" method="post" modelAttribute="UserSignForm">
			...
			<div class="login-actions">
				<span class="login-checkbox">
                            ...
                            <p><a href="/SpringMVCHibernate/forgot">Forgot your password ?</a></p>
			<div class="login-social marg10-btm">
				<p>Sign in using social network:</p>
				    <a href="#" class="btn"><img src="/SpringMVCHibernate/resources/img/twitter-18.png" /> Signin with twitter</a>
				    <a href="#" class="btn"><img src="/SpringMVCHibernate/resources/img/facebook-18.png" /> Signin with facebook</a>			
			</div>
        </form:form>
	   </div> <!-- /form-content -->
